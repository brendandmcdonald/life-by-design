...
var advice = [
    ...
    ["Never be afraid to ask fundamental questions.","Grandma"],
    ["Test it before you build it.","Grandma"],
    ["Are you working on the foundation or the paint job?","Grandma"],
    ["Don't let them change Brendan unless you see it as progress.","Grandma"],
    ["",""],
    ["",""],
];
